...
macanudo.comics_url = "https://github.com/jfacorro/macanudo/blob/master/log/";
...
macanudo.add_comic = function add_comic(parent, date) {
  ...
  var src = [cljs.core.str(macanudo.comics_url), cljs.core.str(y_m_d), cljs.core.str(".jpg?raw\x3dtrue")].join("");
  var div = cljs.core.PersistentVector.fromArray(["\ufdd0:div", cljs.core.PersistentVector.fromArray(["\ufdd0:h4", d_m_y], true), cljs.core.PersistentVector.fromArray(["\ufdd0:img", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:src", src], true)], true)], true);
  return macanudo.append.call(null, parent, macanudo.create_element.call(null, div))
};
...
macanudo.load_page = function load_page(page) {
  ...
  var today = macanudo.dec_date.call(null, new Date, start);
